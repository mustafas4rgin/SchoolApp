...
public class ScholarshipApplicationValidator : AbstractValidator<ScholarshipApplication>
{
    public ScholarshipApplicationValidator()
    {
        RuleFor(sa => sa.ApplicationDate)
            .NotNull()
            .WithMessage("Application date cannot be null.");
